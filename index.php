...
<section class="login-form-wrap">
  <h1>OfflineBook</h1>
  <form class="login-form" method="POST" action="chat.php">
    <label>
      <input type="email" name="myid" id="email" required placeholder="Your Email">
    </label>
     <label>
      <input type="email" name="fid" id="femail" required placeholder="Friends Email">
    </label>
